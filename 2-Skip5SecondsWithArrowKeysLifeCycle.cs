...
public class Skip5SecondsWithArrowKeysLifeCycle : IOnLoadMod, IOnDisableMod
{
    ...
    public void OnLoadMod()
    {
        ...
        Debug.Log($"{nameof(Skip5SecondsWithArrowKeysLifeCycle)}.OnLoadMod");
    }

    public void OnDisableMod()
    {
        Debug.Log($"{nameof(Skip5SecondsWithArrowKeysLifeCycle)}.OnDisableMod");
    }
}
